...
@Autonomous(name = "VuforiaCrater", group = "auto")

public class VuforiaCrater extends armisticeAutoSuper {
    ...
    public void runOpMode(){
        ...
        //Vars
        int initialInches = 50;         //ANGELA THIS 4 U
        ...
        while(!Vuforia.getUsed() /*&& (initialEncoder + (initialInches * CPI)) <  FL.getCurrentPosition()*/){
            Vuforia.robotInformation();
            telemetry.addData("Used?", Vuforia.getUsed());
            telemetry.update();
        }
        ...
        if(useVuforia){
            ...
            telemetry.update();
            //ANGELA, PUT REST OF VALUES USING ADVANCED DEAD RECKONING
        }
